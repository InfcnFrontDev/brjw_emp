...
StoreCooling.CoolingTower = fabric.util.createClass(ActorsBase, {
    ...
    refresh: function (options) {     //每次刷新改变冷水圆柱体高度
        options.CoolingRate = options.CoolingRate > 1 ? 1 : options.CoolingRate;
        this.setOption(options);
        //如果coolingrate为空，不改变冷水柱
        if (this.option.CoolingRate == "undefined") {
            this._renderRefresh();
            return;
        }
        var iwidth = this.option.Width;
        ...
        //保存对象位置
        var ori_position0 = {};
        ori_position0.left = this.group._objects[0].left;
        ori_position0.top = this.group._objects[0].top;
        var ori_position1 = {};
        ori_position1.left = this.group._objects[1].left;
        ori_position1.top = this.group._objects[1].top;
        //var ori_position2 = {};
        //ori_position2.left = this.group._objects[2].left;
        //ori_position2.top = this.group._objects[2].top;
        ...
        //刷新前重置角度和偏移
        delete this.group._objects[0]['angle'];
        delete this.group._objects[1]['angle'];
        this.group._objects[0].left = ori_position0.left;
        this.group._objects[1].left = ori_position1.left;
        //this.group._objects[2].left = ori_position2.left;
        this.group._objects[0].top = ori_position0.top;
        this.group._objects[1].top = ori_position1.top;
        //this.group._objects[2].top = ori_position2.top;
        this._renderRefresh();
    },
