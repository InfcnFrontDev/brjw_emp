...
StoreCooling.OwmPump = fabric.util.createClass(ActorsBase, {
// 上右管道的泵  OwmPump1
...
//            FlowDirection:0,  // public enum FlowDirection {静止 = 0, 顺流 = 1, 逆流 = 2};
    ...
    //    this.canvas.renderAll();
    //},
    _getLightColor:function(isOpen){
        var lightcolor = "red";
        switch (isOpen){
    ...
    initializeobjs:function(){
        ...
        var rect2 = new fabric.Rect({
            left: iwidth/17-iwidth/2,
            top: iheight/10-iheight/2,
            width: iwidth*4/17,
            height: iheight*2/5,
            strokeWidth: 0.1,
            hasBorders:false,
        ...
        //第9部分  状态显示部分(对应cs代码中新加部分,第六部分)
        var rect6 = new fabric.Rect({
            left: iwidth*4/17-iwidth/2,
